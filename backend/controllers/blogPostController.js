...
//@desc Update an exixting blog post
...
//@desc Get blog posts by ststus (all, published or draft) and include counts
//@route GET /api/posts?status=published|draft|all&pages=1
//@access Public
...
//@route GET /api/posts/search?q=keyboard
//@access Public
...
//@desc Increment posts view count
