...
export default function BlogPost() {
  ...
  const [openDeleAlert, setOpenDeleteAlert]= useState({
    open:false,
    data:null,
  });
    ...
    <DashboardLayout activeMenu="Blog Posts">
      ...
      />
        ...
        <div className='mt-5'>
          ...
          <div className='flex items-center justify-center mb-8'>
            <button
            className='flex items-center gap-3 text-sm text-white font-medium bg-black px-2.5 rounded-full text-nowrap hover:scale-105 transition-all cursor-pointer'
            disabled={isLoading}
      ...
      >
        <div className='w-[70vw] md:w-[30vw]'>
          <DeleteAlertContent
          content="Are you sure want to delete this blog post?"
          onDelete={()=> deletePost(openDeleAlert.data)}
          />
        </div>
      </Modal>
    </DashboardLayout>
