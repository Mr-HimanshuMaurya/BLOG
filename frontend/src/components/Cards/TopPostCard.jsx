...
export default function TopPostCard({ title, coverImageUrl, views, likes, maxViews}) {
  ...
  return (
    <div className='bg-white py-4 flex flex-col gap-3 border-b border-gray-100'>
        ...
        <div className='relative w-full h-1.5 bg-sky-100/60 rounded-full overflow-hidden mt-1'>
            <div className='h-full bg-linear-to-r from-sky-500 to-cyan-400 rounded-full transition-all duration-300'
