...
export default function CoverImageSelector({image, setImage, preview, setPreview}) {
    ...
    return <div className='mb-6'>
        ...
        {!image && !preview ? (
            ...
            <div className='relative w-full h-56'>
                ...
                className='absolute top-2 bg-red-500 text-white p-2 rounded-full shadow-md cursor-pointer'
                >
                    <LuTrash/>
                </button>
            </div>
