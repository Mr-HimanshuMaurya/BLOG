      ...
      <div className=''>
          <div className='text-[14px] prose prose-slate dark:prose-invert max-w-none'>
              ...
              components={{
                  ...
                  blockquote({children}){
                      return <blockquote className='border-l-4 border-gray-200 pl-4 italic my-14'>{children}</blockquote>;
                  },
                  h1({children}){
                  ...
                  td({children}){
                      return <td className='px-3 py-2 whitespace-normal text-sm'>{children}</td>;
                  },
                  hr(){
