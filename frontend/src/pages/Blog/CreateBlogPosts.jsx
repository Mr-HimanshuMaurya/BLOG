...
import GenerateBlogPostForm from '../Admin/components/GenerateBlogPostForm'
import toast from 'react-hot-toast'
import uploadImage from "../../utils/uploadsImage"
import { getToastMessagesByType } from '../../utils/helper'
import DeleteAlertContent from '../../components/DeleteAlertContent'

export default function BlogPostEditor({isEdit}) {
    ...
    const handlePublish = async(isDraft) =>{
      ...
      if(!isDraft){
        if(!isEdit && !postData.coverImageUrl){
          setError("Please select s cover image.");
          return;
        }
              ...
              <div className='flex items-center gap-3'>
                ...
                <button
                      className='flex items-center gap-2.5 text-[13px] font-medium text-sky-600 
                                hover:text-white hover:bg-gradient-to-r hover:from-sky-500 hover:to-indigo-500 
